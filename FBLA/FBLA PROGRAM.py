...
class UILog(object):
    ...
    def setup_Ui(self, Form):
        ...
        self.add_hours.setGeometry(QtCore.QRect(250, 20, 91, 31))
        ...
        self.exit_button.setGeometry(QtCore.QRect(250, 140, 91, 31))
        ...
        self.format_time_button.setGeometry(QtCore.QRect(250, 110, 91, 31))
        ...
        self.view_info_button.setGeometry(QtCore.QRect(250, 80, 91, 31))
        ...
        self.table_widget.setGeometry(QtCore.QRect(20, 180, 320, 271))
        ...
        self.delete_hours.setGeometry(QtCore.QRect(250, 50, 91, 31))
        ...
        self.spin_minutes.setGeometry(QtCore.QRect(140, 30, 42, 22))
        ...
        self.label_8.setGeometry(QtCore.QRect(100, 30, 62, 22))
        ...
        self.label_10.setGeometry(QtCore.QRect(190, 30, 62, 22))
        ...
        self.location_edit.setGeometry(QtCore.QRect(60, 70, 113, 20))
    ...
    def get_values(self):
        ...
        if self.location_edit.text() == "":
            ...
            if self.spin_hours.value() == 0 and self.spin_minutes.value() != 0:
                ...
                #This is a very cheap way of doing this but it basically retarts the window to showcase the data that was currently added in.
                Controller.close_hour_logger_reset()
                Controller.open_hour_logger() 
...
class UINavigationPage(object):
    ...
    def setup_Ui(self, MainWindow):
        ...
        self.change_user_password_button.setGeometry(QtCore.QRect(590, 240, 131, 41))
        ...
        self.label_6.setGeometry(QtCore.QRect(40, 400, 71, 21))
...
class UILoginWindow(object):
    def setup_Ui(self, MainWindow):
        ...
        self.label_4.setPixmap(QtGui.QPixmap("download.jpg"))
        self.label_4.setObjectName("label_4")
